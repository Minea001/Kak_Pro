...
<?php 
    ...
    if(isset ($_POST['btn-save'])) {
        ...
        $fields = array('sub_title', 'sub_description', 'info_id');
        $values = array($title, $desc, $info);
        $result = $obj->fun_insertData('tbl_sub_info', $fields, $values);
        if ( $result ) {
            echo "Success";
        }
    }
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Sub Informations</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4 style="color: cornflowerblue;">Sub Informations</h4>      
                                </div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form method="POST">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label for="validationCustom02" class="form-label">Sub Title</label>
                                                    <input type="text" class="form-control" name="title" id="validationCustom02" >
                                                    <div class="valid-feedback">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="validationCustom02" class="form-label">Sub Description</label>
