...
<?php 
    ...
    if(isset ($_POST['btn-save'])) {
        ...
        $fields = array('title','image', 'description', 'location');
        $values = array( $title, $image, $desc, $location);
        $result = $obj->fun_insertData( 'tbl_region', $fields, $values);
        if ( $result ) {
            echo "Success";
        }
    }
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4 style="color: cornflowerblue;">Regions</h4>      
                                </div>
                                <div class="card-body">
                                        ...
                                        <form method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="file" class="form-control" id="validationCustom02" name="logo" >
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="validationCustom02" class="form-label">Location</label>
                                                    <input type="text" class="form-control" id="validationCustom02" name="location" >
                                                </div>
                                            </div>
